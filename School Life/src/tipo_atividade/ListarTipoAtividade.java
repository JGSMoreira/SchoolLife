...
public class ListarTipoAtividade extends JFrame implements MouseListener{
	...
	//BANCO DE DADOS
		...
		public void getDados() {
			carregaDados("select * from tipo_atividade;");
		}
		//BOT�O PESQUISAR
		public void getDadosPesquisa() {
			if (!txtPesq.getText().equals("")) {
				carregaDados("select * from tipo_atividade where nome like '%" + txtPesq.getText() + "%';");
			}
		}
		//CARREGA DADOS
		public void carregaDados(String comando) {
			try {
				...
				while(rs.next()) {
					...
					codProf.setText(rs.getString("idTipo_atividade"));
					
					rs.getInt("idTipo_atividade");
					if (rs.wasNull()) {
						revalidate();
					}
					else {
					...
					btnEditar.addMouseListener(new MouseAdapter() {
						public void mouseClicked(java.awt.event.MouseEvent e) {
							if (e.getSource() == btnEditar) {
								EditarTipoAtividade edita = new EditarTipoAtividade(nomeProf.getText());
							}
						}
					...
					btnVer.addMouseListener(new MouseAdapter() {
						public void mouseClicked(java.awt.event.MouseEvent e) {
							if (e.getSource() == btnVer) {
								VisualizarTipoAtividade visualizar = new VisualizarTipoAtividade(nomeProf.getText());
							}
						}
						public void mouseEntered(java.awt.event.MouseEvent e) {
							if (e.getSource() == btnVer) {
					...
					btnExcluir.addMouseListener(new MouseAdapter() {
						public void mouseClicked(java.awt.event.MouseEvent e) {
							if (e.getSource() == btnExcluir) {
								DeletaTipoAtividade deletar = new DeletaTipoAtividade(nomeProf.getText());
								getDados();
							}
						}
						public void mouseEntered(java.awt.event.MouseEvent e) {
				...
				if (primeiro == 0) {
					...
					addProf.setText("+ ADICIONAR TIPO DE ATIVIDADE");
					gradeInferior.add(addProf);
					addProf.setBounds(575, espacamento - 5, 300, 25);
					addProf.setForeground(textoCor1);
					addProf.setFont(fonteNegrito);
				}
			}
	...
	//ELEMENTOS DA TABELA
		...
		public static void main (String [] args) {
			ListarTipoAtividade list = new ListarTipoAtividade();
		...
		public void mouseClicked(java.awt.event.MouseEvent e) {
			if (e.getSource() == addProf) {
				CadastrarTipoAtividade cad = new CadastrarTipoAtividade();
			}
